...
\usepackage{ragged2e}            % for text alignment inside cells% for nicer line breaks in headers
% -------------------------
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.85\textwidth]{Dec2025_PrecipSummary_Report_v02.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{Dec2025_SnowDepthSummary_Report.png}
  \caption{Box and whisker plots demonstrating SNOTEL-measured climatological December snow depth at (top left) La Sal Mountain, and (top right) Camp Jackson. The difference in monthly precipitation is shown in the bottom panel. The red circle in each panel indicates values for December 2025. }
\end{figure}
...
% Define colors
\definecolor{headerbg}{gray}{0.85}   % light grey for header
\definecolor{tableborder}{gray}{0.6} % border color
